  ...
  return (
    <>
      ...
      <main className="flex flex-col">
        {/* Hero */}
        <section className="relative overflow-hidden bg-white pt-28 pb-10 sm:pt-32 sm:pb-12">
          ...
          <div className="container relative z-10 mx-auto max-w-3xl px-4 sm:px-6">
            ...
            <span className="mt-8 block font-mono text-xs tracking-widest text-ink/60 uppercase">
              {eyebrow}
            </span>
            <h1 className="mt-3 text-4xl font-medium tracking-tight text-ink sm:text-5xl">
              {title}
            </h1>
            <p className="mt-4 font-mono text-xs text-mist">Last updated · {updated}</p>
          </div>
        </section>

        {/* Body */}
        <section className="bg-cloud/40 py-14 sm:py-20">
          <div
            className={[
              "container mx-auto max-w-3xl px-4 sm:px-6",
              "[&>*:first-child]:mt-0",
              "[&_h2]:mt-12 [&_h2]:mb-4 [&_h2]:text-xl [&_h2]:font-medium [&_h2]:tracking-tight [&_h2]:text-ink",
              "[&_p]:mt-5 [&_p]:text-sm [&_p]:leading-7 [&_p]:text-mist sm:[&_p]:text-base sm:[&_p]:leading-8",
              "[&_ul]:mt-5 [&_ul]:space-y-3 [&_ul]:pl-5 [&_li]:list-disc [&_li]:pl-1 [&_li]:text-sm [&_li]:leading-7 [&_li]:text-mist sm:[&_li]:text-base sm:[&_li]:leading-8 [&_li]:marker:text-ink/30",
              "[&_a]:font-medium [&_a]:text-ink [&_a]:underline [&_a]:underline-offset-2 hover:[&_a]:text-ink/70",
