    ...
    <div className="relative min-h-0 flex-1">
      ...
      {!stuck && (
        <button
          ...
          className="border-border bg-popover text-foreground animate-in fade-in-0 zoom-in-95 absolute bottom-3 left-1/2 flex -translate-x-1/2 items-center gap-1 rounded-full border px-2.5 py-1 text-2xs font-medium shadow-md"
